document.addEventListener("DOMContentLoaded", function () {
  ...
  // modal windows
  if (typeof( document.getElementsByClassName('modal-report-thanx__close')[0]) != 'undefined' &&  document.getElementsByClassName('modal-report-thanx__close')[0] != null) {
    var closeModal = [].slice.call(document.getElementsByClassName('modal-box__close'));
    closeModal.forEach(function (element, i) {
      element.addEventListener('click', closeModalHandler);
    });
    document.getElementsByClassName('modal-report-thanx__close')[0].addEventListener('click', closeModalHandler);
